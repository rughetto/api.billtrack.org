...
class DistrictMap < ActiveRecord::Base
  ...
  include Ym4r::GoogleMaps # for getting latitude and longitude information from google
  ...
  def self.get_locations 
    all(:conditions => {:latitude => nil}).each do |district_map|   
      break unless district_map.get_location
      district_map.save
    end  
  end  
